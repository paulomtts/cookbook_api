        ...
        if response.status_code == 200:
            ...
            if access_token:
                ...
                if db_output.status == 200:
                    ...
                    response.set_cookie(key="cbk_s", value=jwt_token, httponly=True, samesite=None, secure=True, domain='https://cbk-frt-a0-0-4-d329a0a2f76c.herokuapp.com/', expires=(60 * 60 * 24 * 7))
                    return response
